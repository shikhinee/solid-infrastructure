...
then
    ...
    then
        ...
        echo "//import useFETCHER from 'tools/useFETCHER'" >> pages/$componentName/index.jsx
        echo "" >> pages/$componentName/index.jsx
        echo "//Layout must be imported here" >> pages/$componentName/index.jsx
        echo "//import LAYOUT from 'layouts/LAYOUT'" >> pages/$componentName/index.jsx
        echo "" >> pages/$componentName/index.jsx
        echo "//Component must be imported here" >> pages/$componentName/index.jsx
        echo "//import COMPONENT from 'components/COMPONENT'" >> pages/$componentName/index.jsx
        echo "" >> pages/$componentName/index.jsx
